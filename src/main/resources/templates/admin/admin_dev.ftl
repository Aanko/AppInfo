                            ...
                            <div class="box-footer clearfix">
                                ...
                                <ul class="pagination no-margin pull-right">
                                    <li><a data-pjax="true"
                                           ...
                                           href="/admin/DevUser">首页</a></li>
                                    <li><a data-pjax="true"
                                           class="btn btn-sm <#if !devUsers.hasPrevious()>disabled</#if>"
                                           href="/admin/DevUser?page=${devUsers.number-1}">上一页</a></li>
                                    <li><a data-pjax="true" class="btn btn-sm <#if !devUsers.hasNext()>disabled</#if>"
                                           href="/admin/DevUser?page=${devUsers.number+1}">下一页</a></li>
                                    <li><a data-pjax="true" class="btn btn-sm <#if !devUsers.hasNext()>disabled</#if>"
                                           href="/admin/DevUser?page=${devUsers.totalPages-1}">尾页</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
